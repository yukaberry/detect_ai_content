...
def app():
    ...
    st.write("""
    ## Meet the people behind TrueNet:

    - **YUKA KUDO**: Team leader and Data Engineer. Based in Berlin. Working at Biology Research Institute.


    - **JÉRÔME MORISSARD**: Experienced Fullstack iOS app Developer. Based in Biarritz. Working at his own company.


    - **ABHINAV BANERJEE**:Tech Consulting. Based in London. Working at Deloitte.


    - **MOHAMED TARAWALLI**: Accountant and system auditor. Based in Nigeria. Working at KPMG


    - **LINA PALACIOS**: Mathematician. Based in Munich. Working at Milliman-Insurance Consulting.
