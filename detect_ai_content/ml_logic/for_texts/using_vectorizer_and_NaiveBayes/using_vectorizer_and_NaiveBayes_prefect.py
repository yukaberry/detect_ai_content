...
# read env variable from params_ml_flow_prefect
from detect_ai_content.ml_logic.params_ml_flow_prefect import *
...
def retrain_full_model():
    ...
    huggingface_df = pd.read_csv(f'{module_dir_path}/../raw_data/texts_merged_dataset_enriched.csv')
    ...
    X = huggingface_df['text']
    y = huggingface_df['generated']
    ...
    mlflow_save_params(
        ...
        row_count= huggingface_df.shape[0],
    ...
    input_example_df = huggingface_df.sample(3)
